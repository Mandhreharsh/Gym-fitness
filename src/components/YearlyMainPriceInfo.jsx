...
const YearlyMainCardInfo = ({mainprice}) => {
    return (
        <div>
        {
            mainprice.map((mainSubscription, index) => {
                return (
                    ...
                    <h1 className="text-center oswald text-[80px]">{mainSubscription.price1}</h1>
                    </div>
                    <li className="text-[#3D3D3D] text-center text-[14px] oswald list-none mt-[-20px]">{mainSubscription.year}</li>
...
export default YearlyMainCardInfo;