...
const Login = ({ formtype, setIsLoggedIn }) => {
    ...
    return (
        <div>
            <div className="LoginMainSection w-full h-[730px] flex justify-center bg-transparent bg-gradient-to-tl from-[#12100e] to-[#3d3d3d]">
                <div className="LoginSubSection bg-white w-[1200px] h-[600px] mt-[60px] bg-aa bg-cover bg-no-repeat rounded-xl shadow-xl shadow-black flex justify-between">
                    <div className="LoginSubSection1 w-9/12 h-[600px] flex justify-center items-center">
                        <div className='LoginSubSection11 h-[200px]'>
