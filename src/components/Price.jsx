    ...
    return (
        <div className="PriceMainPart bg-transparent bg-gradient-to-tl from-[#12100e] to-[#3d3d3d] h-[898px] w-full flex flex-row justify-center">
            <div className=" h-[700px] w-[1300px] mt-[90px] ">
                ...
                <div className="PriceMainPart1 bg-whit h-[550px] ml-[50px] flex flex-row gap-[36px] justify-center w-[1200px]">

                    <div className="Card1 relative bg-gradient-to-tl from-black-300 via-black-600 to-black-800 w-[340px] h-[444px] mt-[45px] shadow-black shadow-xl rounded-xl">
